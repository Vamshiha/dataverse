    ...
    <header>
      <div className="top-bar">
        <span className="top_header">
          Connect With Us  
          <a href="https://youtube.com" className="social youtube">
          ...
          <a href="https://linkedin.com" className="social linkedin">
            <FontAwesomeIcon icon={faLinkedin} size="2x" />
          </a>
          <a href="https://mail.google.com" className="social gmail">
            <GmailIcon />
          </a>
        </span>
